package com.mycompany.rideapp.exception;
...
public enum ErrorCode {
    ...
    EMAIL_NOT_VALID(1008, "Email not valid", HttpStatus.BAD_REQUEST),
    ...
    SIGNAL_KEY_NOT_VALID(1015, "Key error", HttpStatus.BAD_GATEWAY),
    ...
    // FIELD_NOT_NULL(1022,"Some fields can not be null, pls recheck",
    // HttpStatus.NOT_EXTENDED),
    TITLE_NOT_NULL(1023, "Title not null", HttpStatus.BAD_REQUEST),
    IMAGE_NOT_NULL(1023, "Image not null", HttpStatus.BAD_REQUEST),
    ...
    NO_DRIVER_AVAILABLE(1052, "No driver available", HttpStatus.NOT_FOUND),
    REVIEW_ALREADY_EXISTS(1053, "Review already exists for this ride", HttpStatus.CONFLICT),
    REVIEW_NOT_FOUND(1054, "Review not found", HttpStatus.NOT_FOUND),
    RIDE_NOT_FOUND(1055, "Ride not found", HttpStatus.NOT_FOUND);
